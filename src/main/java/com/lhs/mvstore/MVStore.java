...
public class MVStore implements AutoCloseable {
    ...
    private MVMap openMetaMap() {
        ...
        MVMap map = new MVMap(this, metaId);
     ...
     * @return the map
     */
    public <M extends MVMap, K, V> M openMap(String name, MVMap.MapBuilder<M, K, V> builder) {
     ...
     * @return the map
     */
    public <M extends MVMap, K, V> M openMap(int id, MVMap.MapBuilder<M, K, V> builder) {
        storeLock.lock();
        try {
            @SuppressWarnings("unchecked")
            M map = (M) getMap(id);
     ...
     * @return Map
     */
    public <K, V> MVMap getMap(int id) {
        checkOpen();
        @SuppressWarnings("unchecked")
    ...
    private MVMap getLayoutMap(long version) {
        ...
        MVMap oldMap = layout.openReadOnly(c.layoutRootPos, version);
        return oldMap;
    }
